...
GEMINI_API_KEY = "AIzaSyDM-AoDSa_V5AXBmFiklfv93VhUqoH5qp0"  # Replace with your valid API key
...
engine = pyttsx3.init()
 ...
 #st.set_page_config(page_title="BrightAssist", layout="wide", page_icon="🧠")
st.markdown(
    """
    <style>
     .main-title {
...
st.markdown('<div class="main-title">BrightAssist 👁️</div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️  Md Prince | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
